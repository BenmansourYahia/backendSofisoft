...
/**
 * CfgUtilisateur generated by hbm2java
 */
@Entity
@Table(name = "CFG_UTILISATEUR")
public class CfgUtilisateur implements java.io.Serializable {
	...
	public CfgUtilisateur(CfgUtilisateurId id, long numGrpUtilisateur, String codeUtilisateur, String nom,
			String motPasse, Long numVendeur, Long codeDepot, boolean optVendeur) {
		this.id = id;
		this.numGrpUtilisateur = numGrpUtilisateur;
		this.codeUtilisateur = codeUtilisateur;
		this.nom = nom;
	...
	@AttributeOverrides({
			@AttributeOverride(name = "numUtilisateur", column = @Column(name = "NUM_UTILISATEUR", nullable = false, precision = 10, scale = 0)),
